...
void Build_mpi_type(double* a_p, double* b_p, int* n_p, MPI_Datatype* input_mpi_t_p) {
    int array_of_blocklengths[3] = {FIXME, FIXME, FIXME};
    
    MPI_Datatype array_of_types[3] = {FIXME, FIXME, FIXME};
    MPI_Aint a_addr, b_addr, n_addr;
    MPI_Aint array_of_displacements[3] = {0};

    MPI_Get_address(FIXME, FIXME);
    MPI_Get_address(FIXME, FIXME);
    MPI_Get_address(FIXME, FIXME);
    
    array_of_displacements[1] = FIXME;
    array_of_displacements[2] = FIXME;

    MPI_Type_create_struct(FIXME, FIXME, FIXME, FIXME, FIXME);
    MPI_Type_commit(FIXME);
}
...
void Get_input(int my_rank, int comm_sz, double* a_p, double* b_p, int* n_p)
{
    ...
    Build_mpi_type(a_p , b_p , n_p , &FIXME);
    if(my_rank == FIXME) {
        printf(" Enter a, b, and n\n");
        scanf("%lf %lf %d", a_p , b_p , n_p);
    }   
    
    MPI_Bcast(FIXME, FIXME, FIXME, FIXME, FIXME);
    MPI_Type_free(FIXME);
} 