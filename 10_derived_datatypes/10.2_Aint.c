/**
 * @author RookieHPC
 * @brief Original source code at https://rookiehpc.org/mpi/docs/mpi_aint/index.html
 **/
...
int main(int argc, char* argv[])
{
    ...
    switch(my_rank)
    {
        case SENDER:
        {
            ...
            printf("[MPI Process %d] The address of my local variable is %p.\n", my_rank, (void*)my_variable_address);
        ...
        case RECEIVER:
        {
            ...
            printf("[MPI Process %d] The address of the remote variable is %p.\n", my_rank, (void*)remote_variable_address);
            break;
        }
    }
